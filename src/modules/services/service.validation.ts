...
export type serviceInputSchema = z.infer<typeof createServiceSchema>["body"];

export const updataeServiceSchema = createServiceSchema.partial().refine(
  (data:serviceInputSchema) => Object.keys(data).length > 0
)